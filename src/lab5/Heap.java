...
public class Heap<T extends Comparable<T>> {
    ...
    public T peek() {
        //TODO
    	if (container.size() == 0) new IllegalStateException();
    ...
    private void heapifyUp() {
    	...
    	while (this.hasParent(pos) &&
    		this.container.get(pos).compareTo(
    				this.container.get(this.getParentIndex(pos))) < 0) {
    		this.swap(this.getParentIndex(pos), pos);
